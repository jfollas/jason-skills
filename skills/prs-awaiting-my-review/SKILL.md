...
```
PRs awaiting your review in helixosio/helixos (3):

  #494  Helix support for Zorka service-principal auth        keithelder   waited 17d   direct   re-request
  #689  beta/prod Entra provisioning script                   walkeryan    waited  1d   direct   first-time
  #722  add permissions people tab read slice                 mjeaton      waited  1d   via team @backend   first-time
        https://github.com/helixosio/helixos/pull/722
  …
